package com.timess.soundpulse.model.enums;
...
public enum FileTypeEnum {
    ...
    IMAGE("图片", "image", Arrays.asList("jpg", "jpeg", "png", "gif", "webp"), 10 * 1024 * 1024L),
    AUDIO("音频", "audio", Arrays.asList("mp3", "wav", "flac", "ogg"), 100 * 1024 * 1024L),
